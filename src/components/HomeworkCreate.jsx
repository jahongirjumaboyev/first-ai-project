        ...
        <div className="mb-6">
          ...
          <div className="border border-[#e5e7eb] rounded-lg bg-white shadow-sm overflow-hidden focus-within:ring-2 focus-within:ring-[#10b981]/30 focus-within:border-[#10b981]">
            ...
            <div className="flex flex-wrap items-center gap-0.5 px-3 py-2 border-b border-[#f0f0f0] bg-[#fafafa]">
              ...
              {/* B I U S */}
              <ToolBtn title="Bold">
                <span className="font-bold text-[15px] leading-none">B</span>
              </ToolBtn>
              <ToolBtn title="Italic">
                <span className="italic font-semibold text-[15px] leading-none">I</span>
              </ToolBtn>
              <ToolBtn title="Underline">
                <span className="underline text-[15px] leading-none">U</span>
              </ToolBtn>
              <ToolBtn title="Strikethrough">
                <span className="line-through text-[15px] leading-none">S</span>
              </ToolBtn>
